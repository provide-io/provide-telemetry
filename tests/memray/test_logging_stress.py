...
"""Memray stress test for logging processor chain."""
...
def test_logging_stress(
    ...
    baseline = memray_baseline.get("logging_total_allocations")
    assert_allocation_within_threshold(baseline, total_allocations, "logging")
