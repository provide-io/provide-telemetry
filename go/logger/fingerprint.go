...
func ComputeErrorFingerprint(excType string, pcs []uintptr) string {
	return _computeErrorFingerprint(excType, pcs)
}

// _computeErrorFingerprint is the internal implementation.
...
func _computeErrorFingerprintFromParts(excType string, frameParts []string) string {
	return ComputeErrorFingerprintFromParts(excType, frameParts)
}
