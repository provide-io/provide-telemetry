...
fn openobserve_test_endpoints_match_openobserve_layout() {
    let endpoints =
        openobserve_shared::OpenObserveEndpoints::new("http://localhost:5080/api/default");
...
fn openobserve_test_otlp_providers_build_with_http_exporters() {
    ...
    let tracer =
        openobserve_shared::build_tracer_provider(&endpoints, &auth, "rust-openobserve-test");
    let logger =
        openobserve_shared::build_logger_provider(&endpoints, &auth, "rust-openobserve-test");
    let meter =
        openobserve_shared::build_meter_provider(&endpoints, &auth, "rust-openobserve-test");
